...
%msbuild% --version
%msbuild% NormalsRotator.sln /t:Build /p:Configuration=Release;Platform=x64

set shippingOutput=Binaries/windows-Release-x86_64/NormalsRotator/
...
xcopy /y ".\Scripts\Normals Rotator.bat" ".\Output"
